...
const ModalDatas = ({ item, dispatch, setApi, updateApi }) => {
  ...
  // data context
  const { modal_fullscreen, setmodal_fullscreen, tog_fullscreen, isEdit, setIsEdit , addressCompany,addressDataCompany, updateAddressDataCompany, } = useContext(DataContext)
  ...
  const handleAddForm = () => {
    updateAddressData([...addressDataCompany, addressCompany])
  };
      ...
      <Form>
        ...
        >
          <div className="modal-header">
            ...
            >
              {isEdit ? `Chỉnh sửa thông tin` : 'Thêm công ty phái cử'}
            </h5>
            <button
              onClick={() => {
          ...
          <div className="modal-body">
            <Form>
              ...
              <Row className='border border-secondary mt-3'>
                ...
                {addressDataCompany.map((_, index) => {
                  return (
