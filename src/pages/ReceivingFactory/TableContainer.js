      ...
      <Row className="mb-2">
        ...
        <div className="d-flex flex-wrap gap-2">
          <button type="button" className="btn btn-primary">
            All <Badge className="bg-success ms-1">25</Badge>
          </button>
          <button type="button" className="btn btn-outline-secondary">
            Tokyo <span className="badge bg-success ms-1">2</span>
          </button>
          <button type="button" className="btn btn-outline-secondary">
            Okayama <span className="badge bg-success ms-1">2</span>
          </button>
          <button type="button" className="btn btn-outline-secondary">
            Hokkaido <span className="badge bg-success ms-1">6</span>
          </button>
          <button type="button" className="btn btn-outline-secondary">
            Oasaka  <span className="badge bg-success ms-1">4</span>
          </button>
        </div>
